...
export default function Services() {
  ...
  return (
    <section id="services" className="relative bg-[#1A1817] text-white py-12 md:py-20 px-4 md:px-6 overflow-hidden flex flex-col items-center">
      ...
      <motion.div
        ...
        className="absolute top-0 left-1/4 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-orange-500/20 rounded-full blur-[80px] md:blur-[120px]"
      />
      <motion.div
        animate={{
          scale: [1.2, 1, 1.2],
        ...
        className="absolute bottom-0 right-1/4 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-orange-600/15 rounded-full blur-[80px] md:blur-[120px]"
      />
      ...
      >
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-orange/10 border border-orange/20 text-orange text-xs md:text-sm font-bold tracking-widest uppercase mb-4 md:mb-8 backdrop-blur-sm font-heading"
        >
        ...
        <motion.h3
          ...
          className="text-2xl md:text-4xl lg:text-5xl font-serif italic text-orange-500"
        >
          Intelligence
        </motion.h3>
        <motion.p
          ...
          className="text-sm md:text-base text-gray-400 mt-4 md:mt-6 max-w-xl mx-auto px-4"
        >
      ...
      {/* Mobile Card Grid */}
      <div className="md:hidden w-full max-w-md mx-auto grid grid-cols-1 gap-4 mb-8 z-20 px-2">
        {services.map((s, i) => (
          <motion.div
            key={i}
            ...
            viewport={{ once: true }}
            whileTap={{ scale: 0.98 }}
            className="relative overflow-hidden bg-[#2D2A28]/90 backdrop-blur-md border border-gray-700 p-5 rounded-2xl group"
          >
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-to-br from-orange-500/20 via-transparent to-orange-500/20 rounded-2xl"
            />
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <motion.div
                className="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center text-orange-500 flex-shrink-0"
                whileHover={{
                  rotate: 360,
              ...
              <div className="flex-1">
                <motion.h4
                  className="font-bold text-orange-500 mb-1.5"
            ...
            <motion.div
              ...
              className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-orange-500/20 to-transparent rounded-bl-3xl"
            />
          </motion.div>
        ))}
      </div>
      ...
      <div className="relative hidden md:flex w-full max-w-[1000px] aspect-square items-center justify-center">
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.4 }}
        className="mt-8 md:mt-12 w-full px-4 flex justify-center"
      >
        <CreativeButton
          onClick={openModal}
          variant="shimmer"
          size="lg"
          className="text-base md:text-lg px-6 md:px-10 py-4 md:py-5 w-full md:w-auto shadow-lg shadow-orange-500/20"
        >
          <span className="hidden md:inline">Get Started With Marketing Intelligence</span>
